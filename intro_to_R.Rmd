...
date: '`r format(as.Date("2021-10-03"), "%B %d, %Y")`'
output:
  xaringan::moon_reader:
    includes:
      after_body: insert-logo.html
    self_contained: false
    css: [default, middlebury, fc-fonts, stephen.css]
...
- `r icons::fontawesome("twitter")`: follow @eppydoc `r emo::ji("thumbsup")`

- `r icons::fontawesome("linkedin")`: [Stephen Balogun](https://www.linkedin.com/in/stbalogun/) 
]
